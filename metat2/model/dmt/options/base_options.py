...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--timestep_s', type=int, default=50,
                            help='Preset timestep for source domain.')
        parser.add_argument('--timestep_t', type=int, default=50,
                            help='Preset timestep for target domain.')
    ...
    def parse(self, save=False):
        ...
        assert opt.task in ['AST', 'SIS', 'MMIS', 'DMT'], \
